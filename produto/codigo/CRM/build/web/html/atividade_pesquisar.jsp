    ...
    <div class="tela">
        <form id="pesquisa" name="pesquisa">
            <fieldset style="text-align:center">
                <label class="rotuloGrande">Tipo:</label>
                <input type="text" class="entrada" /><br />
                <label class="rotuloGrande">Status:</label>
                <input type="text" class="entrada" /><br />
                <label class="rotuloGrande">Código de atividade:</label>
                <input type="text" class="entrada" /><br />
                <label class="rotuloGrande">Atividade:</label>
                <input type="text" class="entrada" /><br />
                <label class="rotuloGrande">Funcionario:</label>
                <input type="text" class="entrada" /><br />
                <label class="rotuloGrande">Data Inicio:</label>
                <input type="text" class="entrada" />
                <label class="rotuloGrande">Data Fim:</label>
                <input type="text" class="entrada" /><br /> 
                <label class="rotuloGrande"> 
                <input type="submit" value="Pesquisar" style="width: 202px"/></label>
                </fieldset>
        </form>
    </div>
